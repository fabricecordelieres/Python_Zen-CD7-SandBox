...
class ShenCastan:
    ...
    def filter(self, filter_radius=64, alpha=0.25):
        """
    ...
    def show_process(self, save_path = ''):
        ...
        ax2.title.set_text('Smooth, a=' + tag_alpha + " rad=" + str(self.radius_param))
        ax2.axis('off')
        ...
        im.save(save_path+'export_a=' + tag_alpha + '_rad=' + str(self.radius_param) + '.tif')
